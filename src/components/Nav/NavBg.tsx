    ...
    return (
        <div className="nav-background" ref={navBgRef} >
            <svg className="nav-background-svg">
                ...
                <rect ref={topBorderRef} x={topBorder.x} y={topBorder.y} width={topBorder.width} height={topBorder.height} fill="var(--color-primary)" />
                <rect ref={bottomBorderRef} x={bottomBorder.x} y={bottomBorder.y} width={bottomBorder.width} height={bottomBorder.height} fill="var(--color-primary)" />
                ...
                <g ref={innerFrameLeftRef} transform={`translate(${navFrameLeft.x}, ${navFrameLeft.y})`}>
                    ...
                    `} strokeWidth={navFrameLeft.thickness} stroke="var(--color-primary)" fill="none" />
                </g>
                <g ref={innerFrameRightRef} transform={`translate(${navBg.centerX - navFrameRight.width / 2}, ${navFrameRight.y})`}>
                    ...
                    `} strokeWidth={navFrameRight.thickness} stroke="var(--color-primary)" fill="none" />
                </g>
            </svg>
        </div>
    )
